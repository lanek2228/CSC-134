...
/*
    Any constant needed multiple places in the game
    can be set in this file.

    Examples are the size of various containers
    (vectors/arrays) that we'll iterate through

    static constants are "global variables"
